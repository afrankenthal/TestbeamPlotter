...
void makePlots() {
	...
	TFile * file = TFile::Open("../Data/Chewie_Runs10408_10418.root");
	...
	//make1DXYCellChargePlot(XcellChargePlot1Hit, XcellChargePlotNorm1Hit, sensor0, 1, X);
	TH1F * XcellChargePlot2Hits = (TH1F*)file->Get("Charge/Dut0/XcellCharge1D/h1DXcellChargeSecondHit_Dut0");
	//make1DXYCellChargePlot(XcellChargePlot2Hits, XcellChargePlotNorm2Hits, sensor0, 2, X);
	TH1F * XcellChargePlot4Hits = (TH1F*)file->Get("Charge/Dut0/XcellCharge1D/h1DXcellChargeFourthHit_Dut0");
	//make1DXYCellChargePlot(XcellChargePlot4Hits, XcellChargePlotNorm4Hits, sensor0, 4, X);
	...
	//make1DXYCellChargePlot(XcellChargePlot1Hit, XcellChargePlotNorm1Hit, sensor1, X);
	XcellChargePlot2Hits = (TH1F*)file->Get("Charge/Dut1/XcellCharge1D/h1DXcellChargeSecondHit_Dut1");
	//make1DXYCellChargePlot(XcellChargePlot2Hits, XcellChargePlotNorm2Hits, sensor1, 2, X);
	XcellChargePlot4Hits = (TH1F*)file->Get("Charge/Dut1/XcellCharge1D/h1DXcellChargeFourthHit_Dut1");
	//make1DXYCellChargePlot(XcellChargePlot4Hits, XcellChargePlotNorm4Hits, sensor1, 4, X);
	...
	//make1DXYCellChargePlot(YcellChargePlot1Hit, YcellChargePlotNorm1Hit, sensor0, 1, Y);
	TH1F * YcellChargePlot2Hits = (TH1F*)file->Get("Charge/Dut0/YcellCharge1D/h1DYcellChargeSecondHit_Dut0");
	//make1DXYCellChargePlot(YcellChargePlot2Hits, YcellChargePlotNorm2Hits, sensor0, 2, Y);
	TH1F * YcellChargePlot4Hits = (TH1F*)file->Get("Charge/Dut0/YcellCharge1D/h1DYcellChargeFourthHit_Dut0");
	//make1DXYCellChargePlot(YcellChargePlot4Hits, YcellChargePlotNorm4Hits, sensor0, 4, Y);
	...
	//make1DXYCellChargePlot(YcellChargePlot1Hit, YcellChargePlotNorm1Hit, sensor1, 1, Y);
	YcellChargePlot2Hits = (TH1F*)file->Get("Charge/Dut1/YcellCharge1D/h1DYcellChargeSecondHit_Dut1");
	//make1DXYCellChargePlot(YcellChargePlot2Hits, YcellChargePlotNorm2Hits, sensor1, 2, Y);
	YcellChargePlot4Hits = (TH1F*)file->Get("Charge/Dut1/YcellCharge1D/h1DYcellChargeFourthHit_Dut1");
	//make1DXYCellChargePlot(YcellChargePlot4Hits, YcellChargePlotNorm4Hits, sensor1, 4, Y);
	...
	//makeResidualPlots(resPlotDut0, resPlotDut1, 1, "X Residuals -- Cluster Size 2");

	//resPlotDut0 = (TH1F*)file->Get("Resolution/Dut0/XResiduals/hXResiduals_Dut0");
	//resPlotDut1 = (TH1F*)file->Get("Resolution/Dut1/XResiduals/hXResiduals_Dut1");
	//makeResidualPlots(resPlotDut0, resPlotDut1, 1, "X Residuals");
	...
	//makeResidualPlots(resPlotDut0, resPlotDut1, 1, "Y Residuals -- Cluster Size 2");

	//resPlotDut0 = (TH1F*)file->Get("Resolution/Dut0/YResiduals/hYResiduals_Dut0");
	//resPlotDut1 = (TH1F*)file->Get("Resolution/Dut1/YResiduals/hYResiduals_Dut1");
	//makeResidualPlots(resPlotDut0, resPlotDut1, 0, "Y Residuals");
}
